...
export default function Home() {
  ...
  // Periodic winner fetching and re-sync - increased interval for 15-minute distributions
  useEffect(() => {
    if (noHolders) return;
    
    // Changed from 2 minutes to 5 minutes since distributions are now every 15 minutes
